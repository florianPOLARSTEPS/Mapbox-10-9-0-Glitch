package com.example.mapboxglitch
...
import com.example.mapboxglitch.databinding.ActivityGlitchIssueBinding
...
class MapboxGlitchDemoActivity : AppCompatActivity() {
